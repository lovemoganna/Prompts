# Prompt名称：高级中文网页设计与开发专家提示词

## 援引链接
- 原始来源：[生成PPT、生成3D动画，生成网站，生成万物](https://mp.weixin.qq.com/s/mUThidjurJkLauQDU8ceCQ)
- 灵感参考：[Tailwind CSS](https://tailwindcss.com/)、[Font Awesome](https://fontawesome.com/)、[Mermaid.js](https://mermaid.js.org/)
- 相关讨论：未提及，可能来自网页设计社区或AI提示词集合

## 主要作用
该提示词将AI转变为专业网页设计师和前端开发专家，能够基于用户提供的内容创建美观、现代、易读的中文可视化网页。它强调视觉吸引力与信息传达的平衡，并提供了全面的设计指导和技术规范，使AI能生成完整可运行的HTML文件。

### 适用场景
- 将长文本内容（如文章、报告）快速转换为精美网页
- 为商业内容或学术论文创建专业视觉呈现
- 设计包含数据可视化的信息展示页面
- 创建同时具备美观设计和技术功能（如深色模式）的响应式网站
- 为特定主题（如Naval思想）制作概念可视化网页
...
## 效果展示
效果预览：https://poe.com/gptel_App72P7TD58QX
